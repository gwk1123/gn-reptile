...
public class QuarantineServiceImpl implements QuarantineService {
    ...
    public void index_tc_2(ChromeDriver driver, JavascriptExecutor jse) throws InterruptedException {
...
//        jse.executeScript("document.getElementsByClassName('input-submit-div disable')[0].className = 'input-submit-div';");
        ...
        index_tc_3(driver,jse);
    }


    public void index_tc_3(ChromeDriver driver, JavascriptExecutor jse) throws InterruptedException {
//        QuarantineDriver qunarDriver = getQuarantineDriver();
...
//        driver.navigate().to(index_tc_3);
        ...
        index_tc_4( driver, jse);
    }

    public void index_tc_4(ChromeDriver driver, JavascriptExecutor jse) throws InterruptedException {
